...
__export(index_exports, {
  ROUTER_SETTINGS_NAMESPACE: () => ROUTER_SETTINGS_NAMESPACE,
  TieredRouterSection: () => TieredRouterSection,
  apply: () => apply,
  inject: () => inject
});
...
function TieredRouterSection(props) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("button", { type: "button", style: styles.button, onClick: resetAll, disabled: saving || !ready || typeof scope.mutate !== "function" }, "\u6062\u590D\u7EC4\u5408\u914D\u7F6E"),
